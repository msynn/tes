...
parser.add_argument('Lisa', type=str, help="Name of the chat you want to spam")
...
if args.file is None and args.msg is None:
    print("Please enter either a message or file with the message")
    exit(0)

print("You will have 10 seconds to scan the QR code.")
